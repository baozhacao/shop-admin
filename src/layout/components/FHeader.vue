<template>
  ...
  <!-- 修改密码的抽屉组件 -->
  <FromDrawer ref="fromDrawerRef" title="修改密码" confirmText="提交" @submit="onSubmit" closeOnClickModal>
    <el-form :model="form" :rules="rules" ref="refFrom" label-width="80px" size="small">
      ...
      <el-form-item prop="repassword" label="确认密码">
        <el-input v-model="form.repassword" placeholder="请确认密码" type="password" show-password>
        </el-input>
      </el-form-item>
    </el-form>
  </FromDrawer>
